...
<? include(ACOES_APP_PATH."/cliente/mensagem.php"); ?>
<?php
      ...
      <div class="conta-bloco" style="border: none;">
        <div class="conta-bloco-content chat-container">
          ...
          <div class="chat">
            ...
            <!-- Formulário Mensagem -->
            <form id="chat-form" class="chat-form form-validation" method="post" action="<?=URL?>acoes/app/cliente/envia_mensagem.php" enctype="multipart/form-data">
