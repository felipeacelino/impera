...
<? include(ACOES_APP_PATH."/cliente/cadastrar_senha_pag.php"); ?>
<?php
...
<div class="container">
  <div class="pg-login-wrapper">
    ...
    <div class="pg-login-content">
      ...
      <div class="texto">Os melhores imóveis perto deo você</div>
    </div>
    <!-- //Conteúdo -->

    <!-- Formulário -->
    <form id="form-senha" action="<?=URL?>acoes/app/cliente/cadastrar_senha.php" method="post" class="pg-login-form form-validation">
      ...
      <div class="btn-container">
        ...
        <input type="hidden" name="retorno_success" id="retorno_success" value="<?=URL?>cliente/entrar">
