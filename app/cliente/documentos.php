...
<? include(ACOES_APP_PATH . "/cliente/documentos.php"); ?>
<?php
    ...
    <div class="conta-content">
      ...
      <div class="conta-topo">
        ...
        <div class="conta-topo-btns">
          <a href="<?= URL ?>cliente/cadastro-arquivo/insert" class="btn btn-sm btn-primario"><i class="fas fa-plus"></i> Enviar Documento</a>
        </div>
      </div>
                  ...
                  <tr id="arquivo-<?= $documento_enviado['id'] ?>">
                    ...
                    <!-- <td>
                      <div class="conta-tabela-opcoes">
                        <a href="<?= URL ?>cliente/cadastro-arquivo/update/<?= $documento_enviado['id'] ?>" class="btn btn-xs" title="Editar"><i class="fas fa-pencil-alt m-0"></i></a>
              ...
              <tbody>
                ...
                <? foreach ($arquivosRecebidoslist as $documento_recebido) { ?>
                  ...
                  <tr>
                    ...
                    <!--<td>
                      <div class="conta-tabela-opcoes">
                        <a href="<?= URL ?>cliente/cadastro-arquivo/update/<?= $documento_recebido['id'] ?>" class="btn btn-xs" title="Editar"><i class="fas fa-pencil-alt m-0"></i></a>
      ...
      <div class="modal-wrap modal-sm">
        ...
        <div class="modal-body">
          ...
          <div class="modal-btn right">
            <form id="form-remove-arquivo" action="<?= URL ?>acoes/app/cliente/documentos.php" method="post">
              <input type="hidden" name="acao" value="remover">
              <input type="hidden" id="retorno_success" name="retorno_success" value="<?= URL ?>cliente/documentos">
