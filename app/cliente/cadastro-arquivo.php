    ...
    <div class="conta-content">
      ...
      <div class="conta-topo">
        ...
        <div class="conta-topo-btns">
          <a href="<?=URL?>cliente/documentos" class="btn btn-sm btn-primario"><i class="fas fa-angle-left"></i> Voltar</a>
        </div>
      </div>

      <form id="form-arquivo" action="<?=URL?>acoes/app/cliente/documentos.php" method="post" class="form-validation" enctype="multipart/form-data">
        ...
        <div class="conta-bloco">
          <div class="conta-bloco-content">
            <div class="texto"><i class="las la-exclamation-circle" style="font-size: 1.2em; color: #ffbb33;"></i> <b>Para análise de locação só serão necessários os documentos do 1 ao 4.</b><br> Em caso de dúvida acesse a página <a class="link" href="<?=URL?>enviar-documentos" target="_blank">Enviar Documentos</a>.</div>
          </div>
        </div>
