...
$retorno = isset($_GET['retorno']) && $_GET['retorno'] != "" ? Tools::protege($_GET['retorno']) : URL."cliente/inicio/success";
$urlRetorno = isset($_GET['retorno']) && $_GET['retorno'] != "" ? URL."cliente/entrar?retorno=".$retorno : URL."cliente/entrar";
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<div class="container">
  <div class="pg-login-wrapper">
    ...
    <!-- Formulário -->
    <form id="form-cadastro" action="<?=URL?>acoes/app/cliente/cadastro.php" method="post" class="pg-login-form pg-login-form-cadastro form-validation">
      ...
      <div class="campo-container campo-icon">
        <input type="email" name="email" id="cd-email" maxlength="255" class="campo" placeholder="Digite seu e-mail" required data-parsley-trigger="change" data-parsley-remote="<?=URL?>acoes/app/cliente/verifica_email.php" data-parsley-remote-options='{ "type": "POST" }' data-parsley-remote-validator="remote" data-parsley-remote-message="Este endereço de e-mail já está sendo utilizado" />
