...
<? include(ACOES_APP_PATH . '/proprietario/anuncio_fotos_lista.php'); ?>
<?php
    ...
    <div class="conta-content">
      ...
      <div class="conta-bloco">
        ...
        <div class="conta-bloco-content">
          ...
          <form id="form-fotos" action="<?=URL?>acoes/app/proprietario/anuncio_fotos.php" method="post" class="form-validation" enctype="multipart/form-data">
      ...
      <div class="modal-wrap modal-sm">
        ...
        <div class="modal-body">
          ...
          <div class="modal-btn right">
            <form id="form-remove-foto" action="<?=URL?>acoes/app/proprietario/remove_foto_anuncio.php" method="post">
    ...
    <div class="modal warning" id="modal-confirm2">
      <div class="modal-wrap modal-sm">
        ...
        <div class="modal-body">
          ...
          <div class="modal-btn right">
            <form id="form-update-foto" action="<?=URL?>acoes/app/proprietario/update_foto_destaque.php" method="post">
