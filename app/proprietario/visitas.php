...
<? include(ACOES_APP_PATH."/proprietario/visitas.php"); ?>
<?php
      ...
      <div class="modal-wrap modal-sm">
        ...
        <div class="modal-body">
          ...
          <div class="modal-btn right">	
            <form id="form-reagenda-visita" action="<?=URL?>acoes/app/proprietario/visitas.php" method="post">
    ...
    <div class="modal warning" id="modal-confirm2">
      <div class="modal-wrap modal-sm">
        ...
        <div class="modal-body">
          ...
          <div class="modal-btn right">	
            <form id="form-confirmar-visita" action="<?=URL?>acoes/app/proprietario/visitas.php" method="post">
