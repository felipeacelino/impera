...
<? include(ACOES_APP_PATH."/proprietario/mensagem.php"); ?>
<?php
      ...
      <div class="conta-bloco" style="border: none;">
        <div class="conta-bloco-content chat-container">
          ...
          <div class="chat">
            ...
            <!-- Formulário Mensagem -->
            <form id="chat-form" class="chat-form form-validation" method="post" action="<?=URL?>acoes/app/proprietario/envia_mensagem.php" enctype="multipart/form-data">
              <div class="chat-campo-container">
                ...
                <input type="hidden" name="proprietario" value="<?=$idUser?>">
