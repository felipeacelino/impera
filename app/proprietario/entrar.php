...
$retorno = isset($_GET['retorno']) && $_GET['retorno'] != "" ? Tools::protege($_GET['retorno']) : URL."proprietario/inicio";
$urlRetorno = isset($_GET['retorno']) && $_GET['retorno'] != "" ? URL."proprietario/criar-conta?retorno=".$retorno : URL."proprietario/criar-conta";
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<div class="container">
  <div class="pg-login-wrapper">
    ...
    <!-- Formulário -->
    <form id="form-login" action="<?=URL?>acoes/app/proprietario/login.php" method="post" class="pg-login-form form-validation">
...
<div class="modal" id="modal-recuperacao">
  <div class="modal-wrap modal-sm">
    ...
    <div class="modal-body">
      ...
      <form id="form-recuperacao" action="<?=URL?>acoes/app/proprietario/envia_email_recuperacao.php" method="post"
        ...
        <div class="campo-container campo-icon">
          <input type="email" name="email" id="email_recuperacao" maxlength="255" class="campo"
            ...
            data-parsley-remote="<?=URL?>acoes/app/proprietario/verifica_email_recuperacao.php"
            data-parsley-remote-options='{ "type": "POST", "data": { "tipo": "proprietario" } }' 
