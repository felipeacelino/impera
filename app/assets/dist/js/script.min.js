...
function handleStatusLead() {
  var statusLead = $(".status-lead").val();

  if (statusLead == "1") {
    $(".sem-interesse").hide();
    $(".com-interesse").show();
    $(".sem-interesse").find("input, select").prop("disabled", true).prop("required", false);
    $(".com-interesse").find("input, select").prop("disabled", false);
    $(".com-interesse").find("input[data-required], select[data-required]").prop("required", true);
  } else if (statusLead == "0") {
    $(".sem-interesse").show();
    $(".com-interesse").hide();
    $(".sem-interesse").find("input, select").prop("disabled", false);
    $(".sem-interesse").find("input[data-required], select[data-required]").prop("required", true);
    $(".com-interesse").find("input, select").prop("disabled", true).prop("required", false);
  } else {
    $(".sem-interesse").hide();
    $(".com-interesse").hide();
    $(".sem-interesse").find("input, select").prop("disabled", true).prop("required", false);
...
$(".btn-copy-link").on("click", function (ev) {
  ...
  showAlert("Copiado!", "Seu link de afiliado foi copiado, agora você já pode compartilhar com seus clientes e proprietários.", "success");
});
"use strict";
