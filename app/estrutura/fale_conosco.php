<section class="secao fale-conosco" style="background-image: url('<?=URL_APP?>/assets/dist/img/bg_contato.jpg');">
  ...
  <div class="container">
    ...
    <div class="grid-7 grid-m-12 grid-s-12 fale-conosco-infos">
      <h2 class="titulo left">Não sabe qual<br> imóvel escolher?</h2>
      <h3 class="texto">Converse conosco e juntos encontraremos o melhor<br> lugar para você. <b>É de graça!</b></h3>
    ...
    <div class="grid-5 fale-conosco-img">
      <figure><img src="<?=URL_APP?>assets/dist/img/contato.png" alt="Fale Conosco"></figure>
    </div>
