...
<? include(ACOES_APP_PATH."/corretor/anuncio_pag.php"); ?>
<?php
...
<body class="pg-conta" data-pg="imoveis">
  ...
  <main class="conta-container">
    ...
    <div class="conta-content">
      ...
      <form id="form-anuncio" action="<?=URL?>acoes/app/corretor/anuncio.php" method="post" class="form-validation form-anuncio" enctype="multipart/form-data">
            ...
            <div class="bl-dest-campo">
              <div class="row">
                <div class="grid-12 campo-container" style="margin-bottom: 5px;">
                  <label for="residente">Atualmente existe alguém residindo neste imóvel?</label>
                </div>
        ...
        <div class="conta-bloco">
          <div class="conta-bloco-header">
            <div class="conta-bloco-titulo">Dados do proprietário</div>
          </div>
          <div class="conta-bloco-content">
            <div class="row">
              <div class="grid-8 grid-m-12 grid-s-12 campo-container">
                <label for="prop_nome">Nome do proprietário *</label>
                <input type="text" name="prop_nome" id="prop_nome" maxlength="255" class="campo" data-parsley-trigger="change" data-parsley-fullname placeholder="Digite o nome do proprietário" value="<?=$anuncio['prop_nome']?>" required />
              </div>
            </div>
            <div class="row">
              <div class="grid-4 grid-m-12 grid-s-12 campo-container">
                <label for="prop_tel">Telefone do proprietário *</label>
                <input type="tel" name="prop_tel" id="prop_tel" maxlength="255" class="campo telefone" data-parsley-trigger="change" placeholder="Digite o telefone do proprietário" value="<?=$anuncio['prop_tel']?>" required />
              </div>
              <div class="grid-4 grid-m-12 grid-s-12 campo-container">
                <label for="prop_email">E-mail do proprietário</label>
                <input type="email" name="prop_email" id="prop_email" maxlength="255" class="campo" data-parsley-trigger="change" placeholder="Digite o e-mail do proprietário" value="<?=$anuncio['prop_email']?>" />
              </div>
            </div>
            <div class="texto" style="font-size: 15px;"><i class="las la-exclamation-circle" style="color: #ffbb33"></i> As informações do proprietário são solicitadas somente para confirmação de dados e maior segurança na plataforma.</div>
          </div>
        </div>
        <!-- //Proprietário -->
        ...
        <div class="conta-bloco">
          ...
          <div class="conta-bloco-content">
            <div class="texto">
              ...
              <p>Para mais informações, acesse a página <a href="<?=URL?>corretor/ajuda" target="_blank">Me Ajuda</a>, onde você poderá ver mais detalhes sobre as taxas e outras informações importantes.</p>
            </div>
            <div class="campo-container cr-container" style="margin-bottom: 0px;">
              <label class="cr-lbl">
                ...
                <i class="checkbox"></i>
                <span style="font-weight: 600;">Desejo que o imóvel seja anunciado exclusivamente na Impera Real</span>
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="campo-container cr-container">
          <label class="cr-lbl">
            ...
            <i class="checkbox"></i>
            <span style="font-weight: 600;">Confirmo que todas as informações cadastradas no anúncio são verdadeiras e que tenho autorização explícita do proprietário para cadastrar o imóvel.</span>
          </label>
        </div>
        <? } ?>
        ...
        <div class="conta-base-btns">
          <? if ($acao == "update") { ?>
            ...
            <input type="hidden" id="retorno_success" name="retorno_success" value="<?=URL?>corretor/imoveis/<?=$paramRetorno?>">
          <? } else { ?>
            <input type="hidden" id="retorno_success" name="retorno_success" value="<?=URL?>corretor/anuncio_fotos">
          <? } ?>
