...
<? include(ACOES_APP_PATH."/corretor/agendamentos_imobiliaria.php"); ?>
<?php
$titulo_pagina = "Agendamentos Imobiliária - ".TITULO_PAGS;
$descr_site = "";
$keywords_site = "";
?>
<!DOCTYPE html>
...
<body class="pg-conta" data-pg="agendamentos2">
  ...
  <main class="conta-container">
    ...
    <div class="conta-content">
      ...
      <div class="conta-topo">
        <h1 class="conta-titulo">Agendamentos Imobiliária</h1>
      </div>
      <div class="texto" style="margin-bottom: 30px;">Confira os agendamentos direcionados pela imobiliária para você.<br> Clique em <b>Confirmar</b> para aceitar o agendamento ou em <b>Recusar</b> para recusar o agendamento nas opções.</div>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu right">
                          ...
                          <? } ?>
                          <? if ($visita['status'] != "0" && $visita['status'] != "3" && $visita['status'] != "4") { ?>
                          <a href="#" class="dropdown-item btn-confirm" data-id="<?=$visita['id']?>"><i class="fas fa-times"></i>Recusar</a>
                          <? } ?>
                        </div>
                      </div>
                    </td>
    ...
    <div class="modal warning" id="modal-confirm">
      <div class="modal-wrap modal-sm">
        ...
        <div class="modal-header">
          <span class="modal-titulo">Recusar</span>     
        </div>
        <div class="modal-body">
          <div class="modal-alert-icon">
            <i class="fas fa-exclamation-circle"></i>
          </div>
          <p class="texto">Deseja recusar o agendamento desta visita?</p>
          ...
          <div class="modal-btn right">	
            <form id="form-reagenda-visita" action="<?=URL?>acoes/app/corretor/agendamentos_imobiliaria.php" method="post">
              <input type="hidden" name="acao" value="recusar">
              <input type="hidden" name="id_visita" id="id_remove" required>
              <button type="submit" class="btn btn-sm btn-primario">Recusar</button>
            </form>
          </div>  
        </div>
      </div>
    ...
    <div class="modal warning" id="modal-confirm2">
      <div class="modal-wrap modal-sm">
        ...
        <div class="modal-body">
          ...
          <div class="modal-btn right">	
            <form id="form-confirmar-visita" action="<?=URL?>acoes/app/corretor/agendamentos_imobiliaria.php" method="post">
