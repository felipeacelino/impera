  ...
  <main class="conta-container">
    ...
    <div class="conta-content">
      ...
      <div class="conta-topo">
        ...
        <a href="<?=URL?>corretor/anuncio/insert" class="btn btn-sm btn-primario"><i class="fas fa-plus"></i>Cadastrar Novo</a>
        </div>
      </div>
            ...
            <table class="conta-tabela">
              ...
              <tbody>
                ...
                <? foreach ($resultado as $anuncio) { ?>
                  ...
                  <tr>
                    <td>
                      <a href="<?=URL?>corretor/anuncio_fotos/<?=$anuncio['id']?>/update" class="conta-tabela-img" title="Gerenciar fotos"><img src="<?=$anuncio['foto_view']?>" alt="<?=$anuncio['titulo']?>"></a>
                    </td>
                    <td>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu right">
                          ...
                          <a href="<?=URL?>corretor/anuncio_fotos/<?=$anuncio['id']?>/update" class="dropdown-item"><i class="fas fa-camera"></i> Gerenciar fotos</a></li>
                          <a href="<?=URL?>corretor/acompanhar-imovel/<?=$anuncio['id']?>" class="dropdown-item"><i class="las la-search"></i> Acompanhar imóvel</a></li>
                          <a href="<?=URL?>corretor/visitas/<?=$anuncio['id']?>" class="dropdown-item"><i class="las la-calendar-check"></i> Visitas</a></li>
                          <!-- <a href="<?=URL?>corretor/pagamentos/<?=$anuncio['id']?>" class="dropdown-item"><i class="las la-wallet"></i> Pagamentos</a></li> -->
                    ...
                    <td>
                      <div class="conta-tabela-opcoes">
                        <a href="<?=URL?>corretor/anuncio/update/<?=$anuncio['id']?>" class="btn btn-xs btn-terciario" title="Editar"><i class="fas fa-pencil-alt m-0"></i></a>
      ...
      <div class="modal-wrap modal-sm">
        ...
        <div class="modal-body">
          ...
          <div class="modal-btn right">	
            <form id="form-remove-anuncio" action="<?=URL?>acoes/app/corretor/anuncio.php" method="post">
              <input type="hidden" name="acao" value="remover">
              <input type="hidden" id="retorno_success" name="retorno_success" value="<?=URL?>corretor/inicio">
    ...
    <div class="modal warning" id="modal-confirm2">
      <div class="modal-wrap modal-sm">
        ...
        <div class="modal-body">
          ...
          <div class="modal-btn right">	
            <form id="form-duplica-anuncio" action="<?=URL?>acoes/app/corretor/anuncio.php" method="post">
