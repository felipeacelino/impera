...
<? include(ACOES_APP_PATH."/corretor/cadastrar_senha_pag.php"); ?>
<?php
...
<div class="container">
  <div class="pg-login-wrapper">
    ...
    <!-- Formulário -->
    <form id="form-senha" action="<?=URL?>acoes/app/corretor/cadastrar_senha.php" method="post" class="pg-login-form form-validation">
      ...
      <div class="btn-container">
        ...
        <input type="hidden" name="retorno_success" id="retorno_success" value="<?=URL?>corretor/entrar">
