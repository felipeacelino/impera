...
$retorno = isset($_GET['retorno']) && $_GET['retorno'] != "" ? Tools::protege($_GET['retorno']) : URL."afiliado/inicio";
$urlRetorno = isset($_GET['retorno']) && $_GET['retorno'] != "" ? URL."afiliado/criar-conta?retorno=".$retorno : URL."afiliado/criar-conta";
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<div class="container">
  <div class="pg-login-wrapper">
    ...
    <!-- Formulário -->
    <form id="form-login" action="<?=URL?>acoes/app/afiliado/login.php" method="post" class="pg-login-form form-validation">
...
<div class="modal" id="modal-recuperacao">
  <div class="modal-wrap modal-sm">
    ...
    <div class="modal-body">
      ...
      <form id="form-recuperacao" action="<?=URL?>acoes/app/afiliado/envia_email_recuperacao.php" method="post"
        ...
        <div class="campo-container campo-icon">
          <input type="email" name="email" id="email_recuperacao" maxlength="255" class="campo"
            ...
            data-parsley-remote="<?=URL?>acoes/app/afiliado/verifica_email_recuperacao.php"
