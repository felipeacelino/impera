    ...
    <div class="container">
      <div class="grid-10 grid-m-12 grid-s-12 segura-texto" data-aos="fade-up">
        ...
        <div class="btn-container">
          <a href="#" class="btn btn-white btn-modal-restrito"
          data-cliente="<?=URL?>cliente/documentos"
          data-proprietario="<?=URL?>proprietario/documentos"
          data-corretor="<?=URL?>corretor/documentos"
          data-afiliado="<?=URL?>afiliado/documentos">Enviar Documentos</a>
          <a href="<?=URL?>" class="btn btn-white outline btn-modal-restrito"
          data-cliente="<?=URL?>cliente/inicio"
          data-proprietario="<?=URL?>proprietario/inicio"
          data-corretor="<?=URL?>corretor/inicio"
          data-afiliado="<?=URL?>afiliado/inicio">Minha Conta</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="grid-7 grid-m-12 grid-s-12 fale-conosco-infos">
        ...
        <div class="btn-container">
          ...
          data-corretor="<?=URL?>corretor/documentos"
          data-afiliado="<?=URL?>afiliado/documentos">Enviar Documentos</a>
          <a href="#" class="btn btn-white outline btn-modal-restrito"
          data-cliente="<?=URL?>cliente/inicio"
          data-proprietario="<?=URL?>proprietario/inicio"
          data-corretor="<?=URL?>corretor/inicio"
          data-afiliado="<?=URL?>afiliado/inicio">Minha Conta</a>
