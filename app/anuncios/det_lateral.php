...
<div class="anuncio-lateral-wrp">
  <div class="anuncio-det-bloco anuncio-lateral" data-id-img="reserva-mobile">
    ...
    <div class="anuncio-det-bloco-body anuncio-lateral-btns">
      ...
      <button class="btn btn-primario modal-open" data-modal="modal-det-interesse">Tenho Interesse</button>
      <? if ($anuncio['finalidade'] == "venda") { ?>
        <a href="#simulador" class="btn">Simular Financiamento</a>
      <? } else { ?>
        <a href="<?=URL?>contato?assunto=Dúvida imóvel (<?=$anuncio['codigo']?>)&msg=Olá! Gostaria de mais informações sobre o imóvel para alugar (<?=$anuncio['codigo']?>)." class="btn">Mais Informações</a>
      <? } ?>
