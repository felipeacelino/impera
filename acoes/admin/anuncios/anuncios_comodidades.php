...
switch ($acao_enviado) {
	case 'insert':
		$tit_pag_geral = "Cadastrar filtro (Comodidades e Serviços)";
		break;
	case 'edit':
		$tit_pag_geral = "Editar filtro (Comodidades e Serviços)";
		break;
	default:
		$tit_pag_geral = "Comodidades e Serviços (Filtros)";
		break;
}
