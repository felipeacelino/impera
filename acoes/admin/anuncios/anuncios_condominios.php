...
switch ($acao_enviado) {
	case 'insert':
		$tit_pag_geral = "Cadastrar condomínio";
		break;
	case 'edit':
		$tit_pag_geral = "Editar condomínio";
		break;
	default:
		$tit_pag_geral = "Condomínios";
		break;
}
...
if ($acao == "view") {	
    ...
    if ($_POST['filtro_cidade'] != "") {
        ...
        $filtro_cidade = " AND cidade = '".$_SESSION[$pag_include]['filtros']['filtro_cidade']."'";	
