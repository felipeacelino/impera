...
switch ($acao_enviado) {
  case 'insert':
    $tit_pag_geral = "Cadastrar Busca Personalizada";
    break;
  case 'edit':
    $tit_pag_geral = "Editar Busca Personalizada";
    break;
  default:
    $tit_pag_geral = "Buscas Personalizadas";
    break;
}
      ...
      if ($verificaImagens === true) {
        ...
        if ($operacao) {
          ...
          $_SESSION['msg_retorna'] = Tools::alertReturn(1);
					Tools::redireciona("".URL_ADMIN."anuncios/buscas_anuncios/".TOKEN."/view/0/".$ultimo_id);
