...
switch ($acao_enviado) { 
	case 'insert':
		$tit_pag_geral = $anuncio['titulo']." &rsaquo; Cadastrar avaliação";
		break;
	case 'edit':
		$tit_pag_geral = $anuncio['titulo']." &rsaquo; Editar avaliação";
		break;
	default:
		$tit_pag_geral = $anuncio['titulo']." &rsaquo; Avaliações";
		break;
}
