...
switch ($acao_enviado) {
	case 'insert':
		$tit_pag_geral = "Cadastrar filtro (Mobílias & Eletro)";
		break;
	case 'edit':
		$tit_pag_geral = "Editar filtro (Mobílias & Eletro)";
		break;
	default:
		$tit_pag_geral = "Mobílias & Eletro (Filtros)";
		break;
}
