...
switch ($acao_enviado) { 
	case 'insert':
		$tit_pag_geral = $pagina['titulo_pag']." &rsaquo; Cadastrar Bloco";
		break;
	case 'edit':
		$tit_pag_geral = $pagina['titulo_pag']." &rsaquo; Editar Bloco";
		break;
	default:
		$tit_pag_geral = $pagina['titulo_pag']." &rsaquo; Blocos";
		break;
}
