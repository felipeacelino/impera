...
switch ($acao_enviado) { 
	case 'insert':
		$tit_pag_geral = $pagina['titulo_pag']." &rsaquo; Cadastrar ícone";
		break;
	case 'edit':
		$tit_pag_geral = $pagina['titulo_pag']." &rsaquo; Editar ícone";
		break;
	default:
		$tit_pag_geral = $pagina['titulo_pag']." &rsaquo; Ícones";
		break;
}
