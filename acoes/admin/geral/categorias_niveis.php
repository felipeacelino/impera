<?
// CONFIGURAÇÕES
$tabela = "admin_categorias_niveis";
$filtro = "";
...
$campos_unicos = array(
	'categoria' => array(
		'name' => 'categoria',
		'mensagem' => 'Essa permissão já foi cadastrada.'
	)
);
switch ($acao_enviado) {
	case 'insert':
		$tit_pag_geral = "Cadastrar permissão";
		break;
	case 'edit':
		$tit_pag_geral = "Editar permissão";
		break;
	default:
		$tit_pag_geral = "Permissões";
		break;
}
