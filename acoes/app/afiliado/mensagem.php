...
$mensagensCrud = new Crud('afiliados_mensagens');
$tabela = 'afiliados_mensagens';

$user['foto'] = $user['foto'] != "" ? URL."uploads/img/afiliados/".$user['id']."/thumb-150-150/".$user['foto'] : URL."static/img/admin/user-profile.png";
