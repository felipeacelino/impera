...
$mensagensCrud = new Crud('clientes_mensagens');
$tabela = 'clientes_mensagens';

$user['foto'] = $user['foto'] != "" ? URL."uploads/img/clientes/".$user['id']."/thumb-150-150/".$user['foto'] : URL."static/img/admin/user-profile.png";
