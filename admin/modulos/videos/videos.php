            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?=$action_form; ?>" enctype="multipart/form-data">  
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="video" id="video" type="text" class="form-control col-md-7 col-xs-12" value="<?=$linha_edit['video']; ?>" required>
                    <small class="help"><i class="fas fa-info-circle"></i> Ex: https://www.youtube.com/watch?v=<b>fKopy74weus</b></small>
                  </div>
                </div>
                <!--repete -->
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        <tr>
                          ...
                          <!--item -->
                          <td class="tr-lg">                          
                            <iframe src="https://www.youtube.com/embed/<?=$linha['video']; ?>?rel=0&amp;showinfo=0" frameborder="0" gesture="media" allow="encrypted-media" width="220" height="150" allowfullscreen></iframe>
                          </td>
                          <!--item -->

                          <!--item -->
                          <td data-label="Título" class="tr-lg">                          
