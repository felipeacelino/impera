                ...
                <div class="form-group">
                  <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
                    <button type="submit" id="bt2" class="btn btn-success" value="bt2" name="bt2">
                      <i class="fa fa-upload"></i> Enviar Imagens                      
                    </button>
                  </div>
                </div>
                <!--botoes -->                
              ...
              <div class="header_row">  
                ...
                <div class="header_row_right">
                  ...
                  <div class="header_row_item header_row_item_hide">
                    <? if ($limiteQtde > 0) { ?>
                      <i class="fa fa-camera"></i> <?=$totalFotos; ?> de <?=$limiteQtde; ?> foto(s)
                    <? } else { ?>
                      <i class="fa fa-camera"></i> <?=$total_registros; ?> foto(s)
                    <? } ?>                   
                  </div>
                    ...
                    <div class="col-md-55" data-id="<?=$linha['id']?>">                          
                      <div class="thumbnail">
                        ...
                        <? if ($habilita_destaque && $linha['destaque'] == '1') { ?>
                          <span class="destaque" data-toggle="tooltip" title="Imagem destaque"><i class="fa fa-star"></i></span>
                        <? } ?>                            
                        <div class="image view view-first">
                          <img src="<?=$pathView."/thumb-280-224/".$linha['foto']?>" alt="<?=$linha['foto']?>" />
                          <div class="mask no-caption">
                            <div class="tools tools-bottom">

                              <!-- ZOOM -->
                              <? if ($habilita_zoom) { ?>                                    
                                <a href="<?=$pathView."/".$linha['foto']?>" data-lightbox="fotos" data-title="<?=$linha['descricao']?>" data-toggle="tooltip" title="Zoom"><i class="fa fa-search-plus"></i></a>                         
                              <? } ?>

                              <!-- EDITAR TÍTULO -->
                              <? if ($habilita_titulo) { ?>
                                <a id="edit_<?=$linha['id']?>" data-toggle="tooltip" title="Editar descrição"><i class="fas fa-pen-square"></i></a>
                                <script type="text/javascript">
                                  $(function() {
                                    $('#edit_<?=$linha['id']?>').on('click', function(e){ 
                                      ...
                                      $('#modal-image').html('');
                                      $('#modal-image').append('<img src="<?=$pathView."/thumb-280-224/".$linha['foto']?>" alt="<?=$linha['foto']?>" />');
                              ...
                              <? if ($habilita_destaque) { ?>
                                <? if (!$linha['destaque'] == '1') { ?>
                                  <a id="dest_<?=$linha['id']?>" data-toggle="tooltip" title="Destacar imagem"><i class="fa fa-star"></i></a>
                                  <script type="text/javascript">
                                    $(function() {
                              ...
                              <!-- REMOVER -->
                              <a id="remove_<?=$linha['id']?>" data-toggle="tooltip" title="Remover imagem"><i class="fa fa-trash"></i></a>
                              <script type="text/javascript">
