          ...
          <? if($acao == "view"){ ?>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"> 
                  ...
                  <form method="post" action="<?=$acao_filtros?>">
                    <div class="filtros-itens">                    
                      ...
                      <div class="campo-filtro form-group">
                        ...
                        <input type="text" name="filtro_email" id="filtro_email" class="form-control" maxlength="255" value="<?=$_SESSION[$pag_include]['filtros']['filtro_email']?>">
                      </div>
                      <!-- // Item filtro -->                      
              ...
              <div class="header_row">  
                ...
                <!-- ESQUERDA --> 
                <div class="header_row_left header-full">
                  ...
                  <!-- EXPORTAR -->
                  <div class="header_row_item">
                    <button class="btn btn-default" data-toggle="modal" data-target="#modal-lista">
                  ...
                  <div class="header_row_item">
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu pull-right">
                        <li>
                          <a class="acao-ordenar" data-ordem="ORDER BY email ASC"><i class="fas fa-sort-alpha-down"></i> E-mail (A-Z)
                          </a>
                        </li> 
                        <li>
                          <a class="acao-ordenar" data-ordem="ORDER BY email DESC"><i class="fas fa-sort-alpha-down-alt"></i> E-mail (Z-A)
                          </a>
                        </li>
                        <li role="separator" class="divider"></li>
                        <li>
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        <tr>
                          ...
                          <!--item -->
                          <td data-label="E-mail"><i class="far fa-envelope"></i> <?=$linha['email']; ?></td>
                          <!--item --> 

                          <!--item -->
                          <td data-label="Cadastro"><i class="far fa-calendar"></i> <?=Tools::formataData($linha['data_cad']); ?></td>
                          <!--item -->                                    
              ...
              <!-- Modal lista -->
              <div class="modal fade" id="modal-lista" tabindex="-1" role="dialog">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body"> 
                      <div class="form-group">  
                        <textarea name="lista_exporta" id="lista_exporta" rows="10" class="form-control"><?=$lista_exporta?></textarea>                
                      </div>                 
                    </div>
                    <div class="modal-footer"> 
                      <div class="dropdown" style="float: right;">
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li>
                            <a class="clipboard-btn" data-clipboard-target="#lista_exporta"><i class="fas fa-copy"></i> Copiar</a>
                          </li>
                          <li>
                            <a href="<?=URL?>acoes/admin/<?=$pasta_modulo?>/exportar_planilha.php"><i class="fas fa-file-excel"></i> Exportar planilha</a>
                          </li>                                                      
                        </ul>                             
                      </div>   
