...
<? unset($_SESSION['buscas_anuncios']['filtros']); ?>
<!-- estrutura -->
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?= $action_form; ?>" enctype="multipart/form-data">
                ...
                <? if ($acao == "insert") { ?>
                  ...
                  <!--repete -->
                  <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="chegada">
                      Chegada *
                    </label>
                    <div class="col-md-2 col-sm-6 col-xs-12">
                      <input name="chegada" id="chegada" type="text" class="form-control col-md-7 col-xs-12 datepicker data" value="<?= $linha_edit['chegada']; ?>" required>
                    </div>
                    <label class="control-label col-md-1 col-sm-3 col-xs-12" for="saida">
                      Saída *
                    </label>
                    <div class="col-md-2 col-sm-6 col-xs-12">
                      <input name="saida" id="saida" type="text" class="form-control col-md-7 col-xs-12 datepicker data" value="<?= $linha_edit['saida']; ?>" required>
                    </div>
                  </div>
                  <!--repete -->
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        <?
                              ...
                              $current_url_anuncios = $_GET['p'] != '' ?
                                "" . URL . "admin/" . $pasta_modulo . "/buscas_anuncios/" . TOKEN . "/view/0/" . $linha['id'] . "?p2=" . $_GET['p'] : "" . URL . "admin/" . $pasta_modulo . "/buscas_anuncios/" . TOKEN . "/view/0/" . $linha['id'];
                        ...
                        WHERE ba.busca_id = " . $linha['id'], false, 0);
                        ...
                        <tr>
                          ...
                          <td data-label="Título">
                            <p><?= $linha['titulo']; ?></p>
                            <p>
                              <div style="cursor: pointer;" data-clipboard-target="#link-<?= $linha['id']; ?>" class="btn btn-xs btn-default copiar-link"><i class="fa fa-link"></i> Copiar Link</div>
                            </p>
                            <input style="opacity: 0; height: 0px" id="link-<?= $linha['id']; ?>" value="<?= URL ?>busca-personalizada/b-<?= $linha['id']; ?>&chegada=<?= Tools::formataData($linha['chegada']); ?>&saida=<?= Tools::formataData($linha['saida']); ?>">
                          </td>
                          <!--item -->

                          <!--item -->
                          <td data-label="Datas">
                            <p> Chegada: <b><?= Tools::formataData($linha['chegada']); ?></b></p>
                            <p> Saída: <b><?= Tools::formataData($linha['saida']); ?></b></p>
                          </td>
                          <!--item -->
                          ...
                          <!--item -->
                          <td>
                            <a class="btn btn-sm btn-default" href="<?= $current_url_anuncios ?>"><i class="fas fa-search"></i> Anúncios Selecionados (<?= $total_anuncios_selecionados ?>)</a>
                          </td>
                          <!--item -->
