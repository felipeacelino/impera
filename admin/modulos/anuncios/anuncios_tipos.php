                  ...
                  <table class="table table_responsive">
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        $current_url_itens = $_GET['p'] != '' ? 
                        "".URL."admin/".$pasta_modulo."/anuncios_tipos_itens/".TOKEN."/view/0/".$linha['id']."?p2=".$_GET['p'] : 
                        "".URL."admin/".$pasta_modulo."/anuncios_tipos_itens/".TOKEN."/view/0/".$linha['id'];  
                        ?>
                        ...
                        <tr>
                          ...
                          <!--item -->
                          <td>
                            <a class="btn btn-sm btn-default" href="<?=$current_url_itens?>"><i class="fas fa-bars"></i> Itens</a>
                          </td>
                          <!--item -->
