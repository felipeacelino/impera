                  ...
                  <table class="table table_responsive">
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        "".URL."admin/".$pasta_modulo."/".$pag_include."/".TOKEN."/edit/".$linha['id']."/".$tipo['id']."?p=".$_GET['p'] : 
                        "".URL."admin/".$pasta_modulo."/".$pag_include."/".TOKEN."/edit/".$linha['id']."/".$tipo['id'];                                   
                        ?>
                          ...
                          <td align="center" data-label="Ordem">              
                            <select name="altera_oe" class="select_ordem">
                              <? foreach ($ordens as $ordem) { ?> 
                                <option value="<?=$linha['id']?>|<?=$linha['ordem_exibicao']?>|<?=$ordem['ordem_exibicao']?>|<?=$linha['tipo_id']?>" <?=Tools::selected($ordem['ordem_exibicao'],$linha['ordem_exibicao'])?>><?=$ordem['ordem_exibicao']?>º Item</option>
                              <? } ?>
                            </select>
                          </td>
                          <!--item --> 
