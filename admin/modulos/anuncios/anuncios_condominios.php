          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?= $action_form; ?>" enctype="multipart/form-data">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="condominio" id="condominio" type="text" class="form-control col-md-7 col-xs-12" value="<?= $linha_edit['condominio']; ?>" required>
                </div>
              </div>
              <!--repete -->
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="cidade" id="cidade" class="form-control col-md-7 col-xs-12" required>
                    <option value="" hidden>Selecione a cidade</option>
                    <? foreach ($cidades as $cidade) { ?>
                    <option value="<?= $cidade['cidade'] ?>" <?= Tools::selected($cidade['cidade'], $linha_edit['cidade']) ?>><?= $cidade['cidade'] ?></option>
                    <? } ?>
                  </select>
                </div>
              </div>
                ...
                <div class="header_row_item">
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                      <li>
                        <a class="acao-ordenar" data-ordem="ORDER BY condominio ASC"><i class="fas fa-sort-alpha-down"></i> Condomínio (A-Z)
                        </a>
                      </li>
                      <li>
                        <a class="acao-ordenar" data-ordem="ORDER BY condominio DESC"><i class="fas fa-sort-alpha-down-alt"></i> Condomínio (Z-A)
                        </a>
                      </li>
                      <li role="separator" class="divider"></li>
                      <li>
