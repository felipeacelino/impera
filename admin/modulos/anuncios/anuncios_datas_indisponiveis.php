            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?= $action_form; ?>" enctype="multipart/form-data">
                ...
                <div class="texto" style="text-align: center">
                  ...
                  <p>Selecione no mínimo duas datas para funcionar.</p>
                </div>

                <ul class="calendario-legendas center">
                  <li class="primaria"><i class="fas fa-circle"></i> Datas indisponíveis</li>
                  <li class="error"><i class="fas fa-circle"></i> Datas reservadas</li>
                </ul>
                ...
                <input type="hidden" name="anuncio_id" id="anuncio_id" value="<?= $id_enviado2; ?>">
                <? if ($acao == "edit") { ?>
