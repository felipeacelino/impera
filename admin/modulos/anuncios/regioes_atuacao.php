        ...
        <div class="x_panel">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?= $action_form; ?>" enctype="multipart/form-data">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="tipo" id="tipo" class="form-control col-md-7 col-xs-12" required>
                    ...
                    <? foreach ($tiposRegioes as $tipoK => $tipoV) { ?>
                      <option value="<?=$tipoK?>" <?=Tools::selected($tipoK, $linha_edit['tipo']); ?>><?=$tipoV?></option>
                    <? } ?>
                  </select>
                </div>
              </div>
              ...
              <!--repete -->
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="descricao">Regiões (Bairros) *</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea name="descricao" id="descricao" class="form-control col-md-7 col-xs-12" rows="3" required><?=$linha_edit['descricao']; ?></textarea>
                </div>
              </div>
              <!--repete -->
              ...
              <table class="table table_responsive">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <!--item -->
                    <td data-label="Código"><b><?= $linha['codigo']; ?></b></td>
                    <!--item -->

                    <!--item -->
                    <td data-label="Segmento"><?= $tiposRegioes[$linha['tipo']]; ?></td>
                    <!--item -->
                    
                    <!--item -->
                    <td data-label="Regiões"><?= $linha['descricao']; ?></td>
                    <!--item -->
