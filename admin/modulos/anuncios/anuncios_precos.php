            ...
            <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?= $action_form; ?>" enctype="multipart/form-data">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="titulo">
                  Tarifa *<br>
                  <small>Ex: Carnaval, Natal, etc</small>
                </label>
              ...
              <!--repete -->
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="data_inicial">
                  Data inicial *<br>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" name="data_inicial" id="data_inicial" maxlength="255" class="form-control col-md-7 col-xs-12 datepicker" placeholder="DD/MM/AAAA" data-parsley-trigger="change" <? if($acao == "edit"){?>value="<?=Tools::formataData($linha_edit['data_inicial'])?>"<?}?> required />
                </div>
              </div>
              <!--repete -->
              ...
              <!--repete -->
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="data_final">
                  Data final *<br>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="data_final" id="data_final" maxlength="255" class="form-control col-md-7 col-xs-12 datepicker" placeholder="DD/MM/AAAA" data-parsley-trigger="change" <? if($acao == "edit"){?>value="<?=Tools::formataData($linha_edit['data_final'])?>"<?}?> required />
                </div>
              </div>
              <!--repete -->
                ...
                <div class="header_row_item">
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                      <li>
                        <a class="acao-ordenar" data-ordem="ORDER BY titulo ASC"><i class="fas fa-sort-alpha-down"></i> Tarifa (A-Z)
                        </a>
                      </li>
                      <li>
                        <a class="acao-ordenar" data-ordem="ORDER BY titulo DESC"><i class="fas fa-sort-alpha-down-alt"></i> Tarifa (Z-A)
                        </a>
                      </li>
              ...
              <table class="table table_responsive">
                ...
                <tbody>
                  ...
                  <?
                        ...
                        "".URL."admin/".$pasta_modulo."/".$pag_include."/".TOKEN."/edit/".$linha['id']."/".$anuncio['id']."?p=".$_GET['p'] : 
                        "".URL."admin/".$pasta_modulo."/".$pag_include."/".TOKEN."/edit/".$linha['id']."/".$anuncio['id'];                                   
                        ?>
                  ...
                  <tr>
                    ...
                    <!--item -->
                    <td data-label="Tarifa"><b><?= $linha['titulo']; ?></td>
                    <!--item -->

                    <!--item -->
                    <td data-label="Datas">
                      <p>Inicial: <b><?= Tools::formataData($linha['data_inicial']); ?></b></p>
                      <p>Final: <b><?= Tools::formataData($linha['data_final']); ?></p>
                    </td>
                    <!--item -->

                    <!--item -->
                    <td data-label="Valor"><b>R$ <?= Tools::formataMoeda($linha['valor']); ?></b></td>
                    <!--item -->
