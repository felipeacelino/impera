                  ...
                  <div class="header_row_item">
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu pull-right">
                        <li>
                          <a class="acao-ordenar" data-ordem="ORDER BY endereco ASC"><i class="fas fa-sort-alpha-down"></i> Endereço (A-Z)
                          </a>
                        </li> 
                        <li>
                          <a class="acao-ordenar" data-ordem="ORDER BY endereco DESC"><i class="fas fa-sort-alpha-down-alt"></i> Endereço (Z-A)
                          </a>
                        </li>
                        <!-- <li role="separator" class="divider"></li>
                        <li>
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        <tr>
                          ...
                          <!--item -->
                          <td data-label="Endereço"><?=$linha['endereco']; ?></td>
                          <!--item -->
