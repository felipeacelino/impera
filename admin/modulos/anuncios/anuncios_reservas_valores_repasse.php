          ...
          <? if ($acao == "view") { ?>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <form name="excluir" id="form_acao" method="post">
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        <tr>
                          ...
                          <!--item -->
                          <td data-label="Valor">
                            <p>Taxa: <b>R$ <?= Tools::formataMoeda($linha['taxa_repasse']); ?></b></p>
                            <p>Valor: <b>R$ <?= Tools::formataMoeda($linha['valor_repasse']); ?></b></p>
                            <p>Data: <?= Tools::formataData($linha['data_repasse']); ?></p>
                            <? if ($linha['arquivo'] != '') { ?>
                          ...
                          <td data-label="Status">
                            ...
                            <label class="status status<?= $linha['status_repasse']; ?>">
                              <i class="fas fa-circle"></i>
                              <span><?= $status[$linha['status_repasse']]; ?></span>
                            </label>
                          </td>
                          <!--item -->
                ...
                <input type="hidden" name="campo" value="status_repasse" />
