        ...
        <div class="x_panel">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?= $action_form; ?>" enctype="multipart/form-data">
              ...
              <!--repete -->
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="only_admin">
                  Somente na pág. de detalhe *
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <label>
                    <input type="checkbox" name="only_admin" id="only_admin" class="switch" value="1" data-label-true="Sim" data-label-false="Não" <?=Tools::checked("1", $linha_edit['only_admin'])?> />
