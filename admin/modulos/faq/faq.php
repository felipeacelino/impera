          ...
          <? if($acao == "insert" || $acao == "edit"){?>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?=$action_form; ?>" enctype="multipart/form-data">     
                ...
                <!--repete -->
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ckeditor">Resposta *
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="header_row_item">
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu pull-right">
                        <li>
                          <a class="acao-ordenar" data-ordem="ORDER BY titulo ASC"><i class="fas fa-sort-alpha-down"></i> Pergunta (A-Z)
                          </a>
                        </li> 
                        <li>
                          <a class="acao-ordenar" data-ordem="ORDER BY titulo DESC"><i class="fas fa-sort-alpha-down-alt"></i> Pergunta (Z-A)
                          </a>
                        </li>
                        <li role="separator" class="divider"></li>
                        <li>
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        <tr>
                          ...
                          <!--item -->
                          <td data-label="Pergunta"><?=$linha['titulo']; ?></td>
                          <!--item --> 
