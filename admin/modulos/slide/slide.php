            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?=$action_form; ?>" enctype="multipart/form-data">  
                ...
                <!-- <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="titulo" id="titulo" type="text" class="form-control col-md-7 col-xs-12" maxlength="100" value="<?=$linha_edit['titulo']; ?>">
                  </div>
                </div> -->
                <!--repete -->
                ...
                <!-- <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea name="texto" id="texto" class="form-control" rows="2" maxlength="200" data-rule-maxlength="200"><?=$linha_edit['texto']; ?></textarea>
                 </div>
                </div> -->
                <!--repete -->
                ...
                <!--repete -->
                <!-- <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="botao">
                    Botão
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="botao" id="botao" type="text" class="form-control col-md-7 col-xs-12" maxlength="100" value="<?=$linha_edit['botao']; ?>">
                  </div>
                </div> -->
                <!--repete -->
                ...
                <!-- <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="tipo_link" id="tipo_link" class="form-control col-md-7 col-xs-12" required>
                      ...
                      <option value="interno" <?=Tools::selected("interno", $linha_edit['tipo_link']); ?>>URL Interna (Página do próprio site)</option>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="header_row" id="barra_header">                
                ...
                <div class="header_row_right">
                  <div class="header_row_item">
                    <a href="<?= URL_ADMIN; ?>paginas/paginas/<?= TOKEN; ?>/edit/pag_busca" class="btn btn-default btn-header">
                      <i class="fas fa-pen"></i> 
                      <span>Textos da busca</span>
                    </a>
                  </div>   
                  <div class="header_row_item">
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        <tr>
                          ...
                          <td align="center" data-label="Ordem">              
                            <select name="altera_oe" class="select_ordem">
                              <? foreach ($ordens as $ordem) { ?> 
                                <option value="<?=$linha['id']?>|<?=$linha['ordem_exibicao']?>|<?=$ordem['ordem_exibicao']?>" <?=Tools::selected($ordem['ordem_exibicao'],$linha['ordem_exibicao'])?>><?=$ordem['ordem_exibicao']?>º Item</option>
                              <? } ?>
                            </select>
                          </td>
                          <!--item -->
                          ...
                          <!--item -->
                          <td class="tr-lg">                          
                            <img src="<?=URL; ?>uploads/img/<?=$tabela?>/<?=$linha['id']; ?>/thumb-2000-700/<?=$linha['foto']; ?>">
                          </td>
                          <!--item -->
