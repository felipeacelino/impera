            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="form-horizontal form-label-left">
                ...
                <div class="chat">
                  ...
                  <!-- Formulário Mensagem -->
                  <form id="chat-form" class="chat-form form-validation" method="post" action="<?= URL ?>acoes/admin/locatarios/envia_mensagem.php" enctype="multipart/form-data">
                    <div class="chat-campo-container">
                      ...
                      <input type="hidden" name="locatario" value="<?= $origem['id'] ?>">
