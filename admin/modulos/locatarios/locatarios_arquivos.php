          ...
          <? if ($acao == "insert" || $acao == "edit") { ?>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?= $action_form; ?>" enctype="multipart/form-data">
                ...
                <!--repete -->
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="arquivos">Arquivo *
                    <br>
                    <small><i class="fa fa-exclamation-circle"></i> Insira outro arquivo para alterar</small>
                    <? if ($linha_edit['arquivo'] != '') { ?>
                      <br><br>
                      <small><i class="fa fa-exclamation-circle"></i> Arquivo Atual: <a href="<?= URL; ?>uploads/outros/<?= $tabela ?>/<?= $linha_edit['id'] ?>/<?= $linha_edit['arquivo'] ?>" target="_blank" download>Clique aqui para baixar</a></small>
                    <? } ?>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="file" name="arq[arquivo]" accept="*" <? if ($acao == "insert") { ?> required <? } ?>>
                  </div>
                </div>
                <!--repete -->
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        $current_url_edit = $_GET['p'] != '' ?
                          "" . URL . "admin/" . $pasta_modulo . "/" . $pag_include . "/" . TOKEN . "/edit/" . $linha['id'] . "/" . $usuario['id'] . "?p=" . $_GET['p']."/".$filtro_enviado :
                          "" . URL . "admin/" . $pasta_modulo . "/" . $pag_include . "/" . TOKEN . "/edit/" . $linha['id'] . "/" . $usuario['id']."/".$filtro_enviado;
                        ?>
                        ...
                        <tr>
                          ...
                          <td data-label="Arquivo">
                            <p><?= $linha['titulo']; ?></p>
                            <? if ($linha['origem'] == 'enviados_admin') { ?>
                              <p><i class="fa fa-share"></i> Enviado</p>
                            <? } else { ?>
                              <p><i class="fa fa-reply"></i> Recebido</p>
                            <? } ?>
                            <? if ($linha['arquivo'] != '') { ?>
                              <p><i class="fa fa-exclamation-circle"></i> Arquivo Atual: <a href="<?= URL; ?>uploads/outros/<?= $tabela ?>/<?= $linha['id'] ?>/<?= $linha['arquivo'] ?>" target="_blank" download>Clique aqui para baixar</a></p>
                            <? } ?>
                          </td>
                          <!--item -->
