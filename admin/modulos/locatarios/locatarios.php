          ...
          <? if ($acao == "insert" || $acao == "edit") { ?>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?= $action_form; ?>" enctype="multipart/form-data">
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top: 5px;">
                    <label class="cr-lbl" for="fisica" style="margin-left: 0px;">
                      <input type="radio" name="tipo_cadastro" id="fisica" value="fisica" <?= Tools::checked("fisica", $linha_edit['tipo_cadastro']) ?>> Pessoa Física
                    </label>
                    <label class="cr-lbl" for="juridica" style="margin-left: 10px;">
                      <input type="radio" name="tipo_cadastro" id="juridica" value="juridica" <?= Tools::checked("juridica", $linha_edit['tipo_cadastro']) ?>> Pessoa Jurídica
                    </label>
                  </div>
                </div>
                <!--repete -->
                ...
                <!--repete -->
                <div class="item form-group campo-cpf">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cpf">
                    CPF
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="cpf" id="cpf_" type="text" class="form-control col-md-7 col-xs-12 cpf_" value="<?= $linha_edit['cpf']; ?>">
                  </div>
                </div>
                <!--repete -->
                ...
                <div class="item form-group campo-cnpj">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="cnpj" id="cnpj_" type="text" class="form-control col-md-7 col-xs-12 cnpj_" value="<?= $linha_edit['cnpj']; ?>">
                  </div>
                </div>
                <!--repete -->
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="telefone" id="telefone" type="text" class="form-control col-md-7 col-xs-12 telefone" value="<?= $linha_edit['telefone']; ?>">
                  </div>
                </div>
                <!--repete -->
                ...
                <!--repete -->
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="status_atendimento">
                    Em Atendimento *
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <label>
                      <input type="checkbox" name="status_atendimento" id="status_atendimento" class="switch" value="1" data-label-true="Sim" data-label-false="Não" <? if ($acao == 'edit') {
                                                                                                                                                                          Tools::checked("1", $linha_edit['status_atendimento']);
                                                                                                                                                                        } else { ?> checked <? } ?> />
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="filtros-container">
                  <form method="post" action="<?= $acao_filtros ?>">
                    <div class="filtros-itens">
                      ...
                      <!-- Item filtro -->
                      <div class="campo-filtro form-group">
                        <label for="filtro_status_atendimento" class="control-label">Em atendimento:</label>
                        <select name="filtro_status_atendimento" id="filtro_status_atendimento" class="form-control">
                          <option value="">Todos</option>
                          <option value="1" <?= Tools::selected($_SESSION[$pag_include]['filtros']['filtro_status_atendimento'], "1") ?>>Sim</option>
                          <option value="0" <?= Tools::selected($_SESSION[$pag_include]['filtros']['filtro_status_atendimento'], "0") ?>>Não</option>
                        </select>
                      </div>
                      <!-- // Item filtro -->
              ...
              <div class="header_row">
                ...
                <div class="header_row_left">
                  ...
                  <div class="header_row_item">
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li>
                          <a class="acao-multiplos" data-acao="status_atendimento_1"><i class="fas fa-check"></i> Em Atendimento
                          </a>
                        </li>
                        <li>
                          <a class="acao-multiplos" data-acao="status_atendimento_0"><i class="fas fa-times"></i> Fora de Atendimento
                          </a>
                        </li>
                        <li role="separator" class="divider"></li>
                        <li>
                  ...
                  <!-- EXPORTAR -->
                  <div class="header_row_item">
                    <form action="<?= URL ?>acoes/admin/<?= $pasta_modulo ?>/exportar_locatarios.php" method="POST">
                      <button action="submit" class="btn btn-default" href="<?= URL ?>acoes/admin/<?= $pasta_modulo ?>/exportar_locatarios.php">
                        <i class="fa fa-arrow-circle-down"></i>
                        Exportar Locatários (Excel)
                      </button>
                      <input type="hidden" name="filtro_nome" value="<?= $_SESSION[$pag_include]['filtros']['filtro_nome'] ?>">
                      <input type="hidden" name="filtro_email" value="<?= $_SESSION[$pag_include]['filtros']['filtro_email'] ?>">
                      <input type="hidden" name="filtro_status" value="<?= $_SESSION[$pag_include]['filtros']['filtro_status'] ?>">
                      <input type="hidden" name="filtro_status_atendimento" value="<?= $_SESSION[$pag_include]['filtros']['filtro_status_atendimento'] ?>">
                      <input type="hidden" name="filtro_data" value="<?= $_SESSION[$pag_include]['filtros']['filtro_data'] ?>">
                    </form>
                  </div>
                  <!-- FIM EXPORTAR -->
              ...
              <form name="excluir" id="form_acao" method="post">
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        <?
                              ...
                              $url_mensagens = $_GET['p'] != '' ?
                                "" . URL . "admin/" . $pasta_modulo . "/locatarios_mensagens/" . TOKEN . "/insert/0/" . $linha['id'] . "?p2=" . $_GET['p'] : "" . URL . "admin/" . $pasta_modulo . "/locatarios_mensagens/" . TOKEN . "/insert/0/" . $linha['id'];

                              $totalMsgLocatario = $acoes->SelectTotalSQL("SELECT id FROM locatarios_mensagens WHERE lida = 0 AND remetente='usuario' AND id_usuario = " . $linha['id']);

                              // DOCUMENTOS
                              $url_documentos = $_GET['p'] != '' ?
                                "" . URL . "admin/" . $pasta_modulo . "/locatarios_arquivos/" . TOKEN . "/view/0/" . $linha['id'] . "?p2=" . $_GET['p'] : "" . URL . "admin/" . $pasta_modulo . "/locatarios_arquivos/" . TOKEN . "/view/0/" . $linha['id'];

                              // Quantidade de arquivos enviados
                              $totalArquivosEnviados = $acoes->SelectTotalSQL("SELECT * FROM locatarios_arquivos WHERE id_usuario=" . $linha['id'] . " AND origem = 'enviados_admin'");
                              // Quantidade de arquivos recebidos
                              $totalArquivosRecebidos = $acoes->SelectTotalSQL("SELECT * FROM locatarios_arquivos WHERE id_usuario=" . $linha['id'] . " AND origem = 'recebidos_admin'");
                        ...
                        <tr>
                          ...
                          <!--item -->
                          <td data-label="Em Atendimento">
                            <?
                                  $status = array('Não', 'Sim');
                                  ?>
                            <label class="status status<?= $linha['status_atendimento']; ?>">
                              <i class="fas fa-circle"></i>
                              <span><?= $status[$linha['status_atendimento']]; ?></span>
                            </label>
                          </td>
                          <!--item -->
                ...
                <input type="hidden" name="campo" id="campo" value="status" />
