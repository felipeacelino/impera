              ...
              <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?=$action_form; ?>" enctype="multipart/form-data">     
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="titulo" id="titulo" type="text" class="form-control col-md-7 col-xs-12" required="required" value="<?=$linha_edit['titulo']; ?>">
                  </div>
                </div>
                <!--repete -->
                ...
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="categoria">
                    Nome da página / permissão *
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="categoria" id="categoria" type="text" class="form-control col-md-7 col-xs-12" required="required" value="<?=$linha_edit['categoria']; ?>">
                  </div>
                </div>
                <!--repete -->
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        <tr>
                          ...
                          <!--item -->
                          <td data-label="Página / Permissão"><?=$linha['categoria']; ?></td>
                          <!--item -->
