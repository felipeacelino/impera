            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?=$action_form; ?>" enctype="multipart/form-data">  
                ...
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="img[logo]">Logo <? if($acao == "edit"){ ?><small>(Clique na imagem para alterar)</small><? } ?> *
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="file" name="img[logo]" accept="image/*" class="ezdz" <? if($acao == "insert"){ ?> required="required" <? }else{ ?> data-value="<?=URL?>uploads/img/<?=$tabela?>/<?=$linha_edit['id']?>/<?=$linha_edit['logo']?>" <? } ?>>
                    <label for="img[logo]" class="error error-img"></label>
                  </div>
                </div>
                <!--repete -->
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="local" id="local" class="form-control col-md-7 col-xs-12" required>
                      <option value="" hidden>Selecione</option>
                      <? foreach ($locais as $local => $localLbl) { ?>
                        <option value="<?=$local?>" <?=Tools::selected($local, $linha_edit['local']); ?>><?=$localLbl?></option>
                      <? } ?>
                    </select>
                  </div>
                </div>
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        <tr>
                          ...
                          <!--item -->
                          <td class="tr-lg">                          
                            <img src="<?=URL; ?>uploads/img/<?=$tabela?>/<?=$linha['id']; ?>/<?=$linha['logo']; ?>">
                          </td>
                          <!--item -->

                          <!--item -->
                          <td data-label="Local"><?=$locais[$linha['local']]; ?></td>
                          <!--item -->

                          <!--item -->
                          <td data-label="Descrição"><?=$linha['titulo']; ?></td>
                          <!--item -->
