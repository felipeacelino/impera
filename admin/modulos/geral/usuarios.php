            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <form id="form-geral" class="form-horizontal form-label-left" method="post" action="<?=$action_form; ?>" enctype="multipart/form-data">     
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="senha" id="senha" type="password" class="form-control col-md-7 col-xs-12" <? if($acao == "insert"){ ?> required <? } ?> value="">
                  </div>
                </div>
                <!--repete --> 
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="senha2" id="senha2" type="password" class="form-control col-md-7 col-xs-12" <? if($acao == "insert"){ ?> required <? } ?> value="">
                  </div>
                </div>
                <!--repete --> 
                ...
                <!--repete -->
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nivel">
                    Nível de acesso *
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="nivel" id="nivel" class="form-control col-md-7 col-xs-12" required>
                      <option value="" hidden>Selecione</option>
                      <? foreach ($row_niveis as $nivel) { ?>
                        <option value="<?=$nivel['id']?>" <?=Tools::selected($nivel['id'], $linha_edit['nivel']); ?>><?=$nivel['titulo']?></option>
                      <? } ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="filtros-container">
                  <form method="post" action="<?=$acao_filtros?>">
                    <div class="filtros-itens">
                      ...
                      <!-- Item filtro -->
                      <div class="campo-filtro form-group">
                        <label for="filtro_nivel" class="control-label">Nível:</label>
                        <select name="filtro_nivel" id="filtro_nivel" class="form-control">
                          <option value="">Todos</option>
                          <? foreach ($row_niveis as $nivel) { ?>
                            <option value="<?=$nivel['id']?>" <?=Tools::selected($_SESSION[$pag_include]['filtros']['filtro_nivel'], $nivel['id'])?>><?=$nivel['titulo']?></option>
                          <? } ?>
                        </select>                        
                      </div>
                      <!-- // Item filtro -->
                  ...
                  <table class="table table_responsive">
                    ...
                    <tbody>
                      ...
                      <? foreach ($resultado as $linha) { ?>
                        ...
                        <?
                        // Nome do nível
                        $nivel = $acoes->SelectSingle("SELECT titulo FROM admin_niveis WHERE id=".$linha['nivel']."");
                        ...
                        <tr>
                          ...
                          <!--item -->
                          <td data-label="Nome"><i class="far fa-user"></i> <?=$linha['nome']; ?></td>
                          <!--item -->
                          ...
                          <!--item -->
                          <td data-label="Acesso"><?=$nivel['titulo']; ?></td>
                          <!--item -->
