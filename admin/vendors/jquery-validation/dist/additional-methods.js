...
}, "Please specify a valid CNPJ number" );


$.validator.addMethod( "cpfcnpj", function( value ) {
...
}, "Please specify a valid CPF or CNPJ number" );

$.validator.addMethod("fullname", function( value ) {

	wordsLength = value.trim().split(' ').length;
