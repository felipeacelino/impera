...
(function ($) {
    ...
    $.fn.fileinputLocales['pt-BR'] = {
        ...
        msgFileRequired: 'Você deve selecionar algum arquivo antes de enviar.',
        ...
        msgInvalidFileType: 'Tipo inválido para o arquivo "{name}". Apenas arquivos de {types} são permitidos.',
